        ...
        stage('Docker Push Image') {
          ...
          stage('SonarQube analysis') {
			    ...
			    withSonarQubeEnv('sonarqube') {
					                 ...
					                 bat 'dotnet sonarscanner begin /k:"projetojpedelogo-pipeline2" /d:sonar.host.url="http://127.0.0.1:9000"  /d:sonar.login="555fb13f8d7dedfbfcb19fad7d76f38c58f8d4fa"'
